...
> Arbeitsdatei fuer das Lernfeld `qualitaet`.
> PDCA, EFQM, ISO-Normen und Softwarequalität.
...
Sobald Dateien mit dem Praefix `qualitaet-` unter `material/` liegen,
...
### Modul: QM-Methoden & Normen  `qm-methoden`

| Kapitel | Slug | AP1 | Wicht. | Status | Offen fuer ready |
|---|---|:--:|:--:|---|---|
| PDCA-Zyklus | `pdca-zyklus` | ja | 4 | `stub` | **keine MDX-Datei** |
| EFQM-Modell | `efqm-modell` | – | 3 | `stub` | **keine MDX-Datei** |
| ISO 9000–9004 | `iso-9000` | ja | 4 | `stub` | **keine MDX-Datei** |
| ISO 25010 – Softwarequalität | `iso-25010` | ja | 4 | `stub` | **keine MDX-Datei** |
