...
> Arbeitsdatei fuer das Lernfeld `sicherheit`.
> DSGVO, Verschlüsselung, Passwörter, Angriffsvektoren.
...
Sobald Dateien mit dem Praefix `sicherheit-` unter `material/` liegen,
...
**4 von 11 Kapiteln** stehen auf `ready` oder `final`.
...
### Modul: DSGVO & Kryptographie  `dsgvo-krypto`
...
### Modul: Betriebssicherheit  `betrieb-sicherheit`
