...
> Arbeitsdatei fuer das Lernfeld `arbeitsrecht`.
...
Sobald Dateien mit dem Praefix `arbeitsrecht-` unter `material/` liegen,
...
**0 von 2 Kapiteln** stehen auf `ready` oder `final`.
...
### Modul: Ausbildung & Recht  `ausbildung`

| Kapitel | Slug | AP1 | Wicht. | Status | Offen fuer ready |
|---|---|:--:|:--:|---|---|
| BBiG & Ausbildungsvertrag | `bbig-ausbildungsvertrag` | – | 4 | `stub` | **keine MDX-Datei** |
| Arbeitnehmerrechte & Kündigungsschutz | `arbeitnehmerrechte` | – | 3 | `stub` | **keine MDX-Datei** |
