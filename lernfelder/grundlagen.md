...
> Arbeitsdatei fuer das Lernfeld `grundlagen`.
> Wie ein Computer denkt: Bits, Bytes, Zahlensysteme, Logik.
...
**3 von 5 Kapiteln** stehen auf `ready` oder `final`.
...
### Modul: Rechnerarchitektur  `rechnerarchitektur`

| Kapitel | Slug | AP1 | Wicht. | Status | Offen fuer ready |
|---|---|:--:|:--:|---|---|
| Von-Neumann-Architektur | `von-neumann` | ja | 5 | `draft` | Ziele, Terme, Schritte, Fehler, Quellen |

### Modul: Zahlen & Einheiten  `zahlen`

| Kapitel | Slug | AP1 | Wicht. | Status | Offen fuer ready |
|---|---|:--:|:--:|---|---|
| Bit & Byte – die kleinsten Einheiten | `bit-byte` | ja | 5 | `ready` | — |
| Zahlensysteme (Dual, Hex, Dezimal) | `zahlensysteme` | ja | 5 | `final` | — |
| SI- und Binärpräfixe (KB vs. KiB) | `prefixe` | ja | 5 | `ready` | — |

### Modul: Logik & Gatter  `logikgatter`

| Kapitel | Slug | AP1 | Wicht. | Status | Offen fuer ready |
|---|---|:--:|:--:|---|---|
| Boolesche Algebra & Logikgatter | `logikgatter` | ja | 4 | `stub` | **keine MDX-Datei** |
