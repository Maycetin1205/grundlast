...
> Arbeitsdatei fuer das Lernfeld `hardware`.
> Die Maschine hinter der Software.
...
Sobald Dateien mit dem Praefix `hardware-` unter `material/` liegen,
...
**3 von 6 Kapiteln** stehen auf `ready` oder `final`.
...
### Modul: PC-Komponenten  `komponenten`

| Kapitel | Slug | AP1 | Wicht. | Status | Offen fuer ready |
|---|---|:--:|:--:|---|---|
| CPU, RAM und Speicher | `cpu-ram-speicher` | ja | 5 | `ready` | — |

### Modul: Schnittstellen & Peripherie  `schnittstellen`

| Kapitel | Slug | AP1 | Wicht. | Status | Offen fuer ready |
|---|---|:--:|:--:|---|---|
| Hardware, Schnittstellen & Peripherie auswählen | `hardware-schnittstellen` | ja | 5 | `ready` | — |
| Homeoffice, Telearbeit & Ergonomie | `homeoffice-ergonomie` | ja | 5 | `ready` | Terme, Schritte, Fehler |

### Modul: Speicher & Verfügbarkeit  `speichersysteme`

| Kapitel | Slug | AP1 | Wicht. | Status | Offen fuer ready |
|---|---|:--:|:--:|---|---|
| RAID-Systeme (0, 1, 5, 6, 10) | `raid-systeme` | ja | 5 | `draft` | — |
| USV-Systeme | `usv-systeme` | ja | 4 | `draft` | Ziele, Analogie, Tabelle, Schritte, Quellen |

### Modul: Bild- & Scandaten rechnen  `bilddaten`

| Kapitel | Slug | AP1 | Wicht. | Status | Offen fuer ready |
|---|---|:--:|:--:|---|---|
| Scan- & Bilddaten rechnen (DPI, Farbtiefe) | `scan-bilddaten` | ja | 4 | `draft` | Ziele, Analogie, Terme, Quellen |
