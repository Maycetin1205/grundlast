...
> Arbeitsdatei fuer das Lernfeld `software`.
> Algorithmen, Paradigmen, UML.
...
Sobald Dateien mit dem Praefix `software-` unter `material/` liegen,
...
**2 von 9 Kapiteln** stehen auf `ready` oder `final`.
...
| Kapitel | Slug | AP1 | Wicht. | Status | Offen fuer ready |
|---|---|:--:|:--:|---|---|
| UML-Use-Case-Diagramm | `use-case-diagramm` | ja | 5 | `ready` | Terme, Fehler |
| UML-Beziehungen (Komposition, Aggregation) | `uml-beziehungen` | – | 3 | `stub` | **keine MDX-Datei** |

### Modul: Programmierkonzepte  `paradigmen`

| Kapitel | Slug | AP1 | Wicht. | Status | Offen fuer ready |
|---|---|:--:|:--:|---|---|
| Programmierparadigmen (OOP, prozedural, funktional) | `programmierparadigmen` | ja | 4 | `stub` | **keine MDX-Datei** |
| Libraries vs. Frameworks | `libraries-frameworks` | – | 3 | `stub` | **keine MDX-Datei** |
| OOP-Grundlagen (Klassen, Objekte, Vererbung) | `oop-basics` | – | 4 | `stub` | **keine MDX-Datei** |

### Modul: Moderne Entwicklung  `moderne-entwicklung`

| Kapitel | Slug | AP1 | Wicht. | Status | Offen fuer ready |
|---|---|:--:|:--:|---|---|
| Git & Versionsverwaltung | `git-versionsverwaltung` | – | 4 | `stub` | **keine MDX-Datei** |
| Teststrategien (White-Box, Black-Box, Unit-Tests) | `teststrategien` | ja | 4 | `stub` | **keine MDX-Datei** |
