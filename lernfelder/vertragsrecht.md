...
> Arbeitsdatei fuer das Lernfeld `vertragsrecht`.
> Gewährleistung, Mängelrüge, Vertragsstörungen im Handelskauf.
...
Sobald Dateien mit dem Praefix `vertragsrecht-` unter `material/` liegen,
...
**4 von 6 Kapiteln** stehen auf `ready` oder `final`.
...
### Modul: Verträge & Störungen  `vertraege`

| Kapitel | Slug | AP1 | Wicht. | Status | Offen fuer ready |
|---|---|:--:|:--:|---|---|
| Vertragsarten: Kaufvertrag, Dienstvertrag & Werkvertrag | `vertragsarten` | ja | 4 | `ready` | Schritte |
| Rechnung, Zahlungsziel & Aufbewahrungsfristen | `rechnung-zahlungsziel-aufbewahrungsfristen` | ja | 5 | `ready` | — |
| Gewährleistung & Garantie | `gewaehrleistung` | ja | 4 | `stub` | **keine MDX-Datei** |
| Mängelrüge im Handelskauf | `maengelruege` | ja | 5 | `ready` | Terme, Schritte, Fehler |
| Vertragsstörungen (Verzug, Mängel, Unmöglichkeit) | `vertragsstoerungen` | ja | 5 | `ready` | Terme, Schritte, Fehler |
| Zweiseitiger Handelskauf | `zweiseitiger-handelskauf` | ja | 4 | `stub` | **keine MDX-Datei** |
