...
> Arbeitsdatei fuer das Lernfeld `aktuell`.
> KI-Grundlagen, Cloud-Konzepte und Lizenzmodelle.
...
Sobald Dateien mit dem Praefix `aktuell-` unter `material/` liegen,
...
**2 von 3 Kapiteln** stehen auf `ready` oder `final`.
...
### Modul: Neue & aktuelle Themen  `neue-themen`

| Kapitel | Slug | AP1 | Wicht. | Status | Offen fuer ready |
|---|---|:--:|:--:|---|---|
| KI-Grundlagen (ML, neuronale Netze) | `ki-grundlagen` | ja | 5 | `ready` | Terme, Schritte, Fehler |
| Cloud-Konzepte (IaaS, PaaS, SaaS) | `cloud-konzepte` | ja | 4 | `stub` | **keine MDX-Datei** |
| Lizenzmodelle (Open Source, proprietär, SaaS) | `lizenzmodelle` | ja | 5 | `ready` | Terme, Schritte, Fehler |
