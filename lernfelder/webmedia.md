...
> Arbeitsdatei fuer das Lernfeld `webmedia`.
> Responsive Design, Wireframes, Softwareergonomie, Medienkompression.
...
**1 von 5 Kapiteln** stehen auf `ready` oder `final`.
...
### Modul: Webdesign & Ergonomie  `webdesign`

| Kapitel | Slug | AP1 | Wicht. | Status | Offen fuer ready |
|---|---|:--:|:--:|---|---|
| Statische vs. dynamische Webseiten | `website-statisch-dynamisch` | ja | 5 | `ready` | Terme, Schritte, Fehler |
| Responsive Webdesign | `responsive-webdesign` | ja | 4 | `stub` | **keine MDX-Datei** |
| Mockup & Wireframe | `mockup-wireframe` | ja | 4 | `stub` | **keine MDX-Datei** |
| Softwareergonomie & Barrierefreiheit | `softwareergonomie` | ja | 4 | `stub` | **keine MDX-Datei** |

### Modul: Mediendaten & Kompression  `medien`

| Kapitel | Slug | AP1 | Wicht. | Status | Offen fuer ready |
|---|---|:--:|:--:|---|---|
| Audio, MP3 & Datenkompression | `audio-kompression` | ja | 4 | `stub` | **keine MDX-Datei** |
