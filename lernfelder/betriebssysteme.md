# Betriebssysteme & IT-Systeme

> Arbeitsdatei fuer das Lernfeld `betriebssysteme`.
> Linux, Dateisysteme, Prozesse, Virtualisierung und Unternehmenssoftware.
...
### Modul: Betriebssystem-Grundlagen  `os-grundlagen`

| Kapitel | Slug | AP1 | Wicht. | Status | Offen fuer ready |
|---|---|:--:|:--:|---|---|
| Linux-Dateiberechtigungen (chmod, rwx) | `linux-chmod` | ja | 5 | `draft` | Ziele, Analogie, Terme, Quellen |
| Dateisysteme (FAT32, NTFS, ext4, APFS) | `dateisysteme` | ja | 4 | `ready` | Schritte, Fehler |
| Prozesse, Threads & Tasks | `prozess-thread` | ja | 4 | `ready` | — |

### Modul: IT-Infrastruktur & Software  `it-infrastruktur`

| Kapitel | Slug | AP1 | Wicht. | Status | Offen fuer ready |
|---|---|:--:|:--:|---|---|
| Zentrale vs. dezentrale IT-Systeme | `zentral-dezentral` | ja | 4 | `ready` | — |
| Virtualisierung & Hypervisor | `virtualisierung` | ja | 5 | `draft` | Ziele, Terme, Schritte, Quellen |
| CRM, ERP, DMS & CMS – Unternehmenssoftware | `crm-erp-dms` | ja | 4 | `ready` | Schritte |
