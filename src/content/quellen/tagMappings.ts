...
export const slugTags: Record<string, string[]> = {
  ...
  'usv-systeme': ['ordnung', 'hardware', 'sicherheit', 'verfuegbarkeit', 'usv', 'ups', 'stromversorgung', 'leistungsfaktor', 'runtime'],
  'scan-bilddaten': ['ordnung', 'datenmenge', 'bit', 'byte', 'praefix', 'binaerpraefix', 'dezimalpraefix', 'scan', 'bilddaten', 'dpi', 'farbtiefe', 'kompression'],
  'linux-chmod': ['sicherheit', 'betriebssystem', 'linux', 'chmod', 'oktal', 'dateirechte', 'posix', 'rwx', 'owner', 'group', 'other', 'suid', 'sgid', 'sticky'],
  'prozess-thread': ['ordnung', 'betriebssystem', 'prozess', 'thread', 'task', 'scheduler', 'multitasking'],
...
export const lessonSourceIds: Record<string, string[]> = {
  ...
  dateisysteme: [
    ...
    'fiausbv',
    'bibb-fachinformatiker',
    'microsoft-filesystem-functionality',
    'microsoft-ntfs-overview',
    'linux-kernel-ext4-inodes',
    'linux-kernel-ext4-ifork',
    'linux-kernel-ext4-journal',
    'apple-apfs-foundation-json',
    'posix-chmod',
  ],
  zahlensysteme: [
    'kmk-rahmenlehrplan',
