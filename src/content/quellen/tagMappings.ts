...
export const slugTags: Record<string, string[]> = {
  ...
  marktformen: ['wirtschaft', 'markt', 'angebot', 'nachfrage', 'marktgleichgewicht', 'marktform', 'wettbewerb', 'marktmacht', 'zielgruppe', 'marktsegmentierung', 'kundennutzen', 'marketing', 'kommunikation', 'werbung', 'aida'],
  eigenfremdfinanzierung: ['finanzierung', 'eigenfinanzierung', 'fremdfinanzierung', 'eigenkapital', 'fremdkapital', 'darlehen', 'zins', 'tilgung'],
  'organisationsformen-leitbild-nachhaltigkeit-esg': ['wirtschaft', 'leitbild', 'nachhaltigkeit', 'lebenszyklus', 'funktionale-einheit', 'tco', 'lebenszykluskosten', 'energie', 'beschaffung', 'reparierbarkeit', 'kreislaufwirtschaft', 'wiederverwendung', 'recycling', 'esg', 'environmental', 'social', 'governance', 'greenwashing'],
  rechtsformen: ['wirtschaft', 'recht', 'rechtsform', 'unternehmensform', 'einzelunternehmen', 'personengesellschaft', 'kapitalgesellschaft', 'ohg', 'kg', 'komplementaer', 'kommanditist', 'gmbh', 'aktiengesellschaft', 'ag', 'haftung', 'mindestkapital', 'vertretung'],
  'vollmachten-im-betrieb': ['wirtschaft', 'recht', 'vollmacht', 'prokura', 'handlungsvollmacht', 'vertretung', 'vertretungsmacht', 'innenverhaeltnis', 'aussenverhaeltnis', 'handelsregister'],
  'unternehmen-ziele-wertschoepfung': ['wirtschaft', 'unternehmen', 'betrieb', 'wertschoepfung', 'wertschoepfungskette', 'vorleistung', 'produktionswert', 'anspruchsgruppe', 'stakeholder', 'kunden', 'lieferanten'],
  'bbig-ausbildungsvertrag': ['ordnung', 'ausbildung', 'recht', 'ausbildungsvertrag', 'ausbildungsnachweis', 'arbeitsschutz', 'gefaehrdungsbeurteilung', 'berufliche-verantwortung'],
}
