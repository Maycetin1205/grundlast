  ...
  // ── 6. SOFTWAREENTWICKLUNG ───────────────────────────────────────────────
  {
    ...
    moduls: [
      ...
      },
      {
        ...
        title: "UML-Diagramme",
        lessons: [
          { slug: "use-case-diagramm", title: "UML-Use-Case-Diagramm", minutes: 10, importance: 4, exam: true, status: "stub" },
    ...
    moduls: [
      {
        ...
        lessons: [
          ...
          { slug: "maengelruege", title: "Mängelrüge im Handelskauf", minutes: 8, importance: 4, exam: true, status: "stub" },
          { slug: "vertragsstoerungen", title: "Vertragsstörungen (Verzug, Unmöglichkeit)", minutes: 10, importance: 4, exam: true, status: "stub" },
